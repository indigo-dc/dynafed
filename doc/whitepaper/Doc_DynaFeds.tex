...
When using the S3 signing algorithm, by default the URL prefix will have to be in the format visible in the following example:\\
...
Please consult your provider of Cloud storage to verify which URL format has to be used.\\
