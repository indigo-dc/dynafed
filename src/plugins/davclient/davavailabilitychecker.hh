...
public:
    DavAvailabilityChecker(Davix::Context* davx, const Davix::RequestParams & p, const std::string & uri_ping, unsigned long time_interval = 5000, struct timespec* max_latency = NULL);
